...
?>
				...
				<a href="#" onclick="javascript:openWin=open('show_performance.php?action=t&p_id=<?php echo $p_rows[0]; ?>' ,'','width=450,height=450,scrollbars=no');"><?php echo $p_rows[1]; ?></a></td>
<?php
			}else{
?>
  </tr><tr>
	<td width="50" height="25" align="center" valign="middle"><a href="#" onclick="javascript:openWin=open('show_performance.php?action=t&p_id=<?php echo $p_rows[0]; ?>' ,'','width=450,height=450,scrollbars=no');"><?php echo $p_rows[1]; ?></a></td>
<?php
				$num = 0;
			}
			$num++;	
