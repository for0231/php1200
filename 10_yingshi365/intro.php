...
<?php
	...
	if($_SESSION[name]<>""){
?>
				<input name="Submit" type="button" <?php  if ($_SESSION[grades]<>"高级会员"){ echo "disabled";}?> value="  下  载  " onClick="javascript:Wopen=location='download.php?action=audio&id=<?php echo $rst->fields[16]; ?>';">
<?php
	}
?>				                    
