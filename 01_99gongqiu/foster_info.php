    ...
    <td width="563" height="587" valign="top" bgcolor="#FFFFFF"><table width="563" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="96" align="center" valign="top"><br>
          <?php
			$date1=date("Y-m-d");
			$sgsql=mysql_query("select * from tb_leaguerinfo  where type='培训信息' and showday>='$date1' and checkstate=1 ");
          ...
          <table width="540" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="26"><span class="style1">『培训信息』</span><span class="style8">&nbsp;<?php echo $sginfo[title];?>&nbsp;</span><span class="style6">&nbsp;<?php echo $sginfo[edate];?></span></td>
            </tr>
            <tr>
...
$sql=mysql_query("select count(*) as total from tb_info where type='培训信息' and checkstate=1");
...
$gsql=mysql_query("select * from tb_info where type='培训信息' and checkstate=1 order by edate desc limit ".($page-1)*$pagesize.",$pagesize");
...
&nbsp;条&nbsp;每页显示&nbsp;<?php echo $pagesize;?>&nbsp;条&nbsp;第&nbsp;<?php echo $page;?>&nbsp;页/共&nbsp;<?php echo $pagecount; ?>&nbsp;页
      <?php
		  ...
		  {
		  ?>
      <a href="foster.php?page=1" title="首页"></a><a href="foster.php?page=<?php echo $page-1;?>" title="前一页">
      <?php
		  }
		   if($pagecount<=4){
