    ...
    <td width="563" height="587" valign="top" bgcolor="#FFFFFF"><table width="563" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td height="96" align="center" valign="top"><br>
          <?php
			$date1=date("Y-m-d");
			$sgsql=mysql_query("select * from tb_leaguerinfo  where type='求购信息' and showday>='$date1' and checkstate=1 ");
          ...
          <table width="540" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td height="26"><span class="style1">『求购信息』</span><span class="style8">&nbsp;<?php echo $sginfo[title];?>&nbsp;</span><span class="style6">&nbsp;<?php echo $sginfo[edate];?></span></td>
            </tr>
            <tr>
...
<br>
<?php
$sql=mysql_query("select count(*) as total from tb_info where type='求购信息' and checkstate=1");
...
$gsql=mysql_query("select * from tb_info where type='求购信息' and checkstate=1 order by edate desc limit ".($page-1)*$pagesize.",$pagesize");
